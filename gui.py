...
model=load_models('Age_Sex_Detecation.h5')
...
#Definig Detect fuction which detects the age gender of the person in image using model
...
upload=Button(top,text="Upload an Image",command=upload_image,padyx=10,pady=5)
